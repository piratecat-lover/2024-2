...
part_tiles = (w_tiles + (width % 30 != 0)) * (h_tiles + (height % 30 != 0)) - whole_tiles
...
"""
12.
Key: 파리 속력 * 철로 길이 / (기차 A 속력 + 기차 B 속력)
"""
...
c = 8
# a, b, c, d = 3, 5, 8, 16
fly_distance = int(c) * int(d) / (int(a) + int(b))
print('파리가 날아다닌 거리: ', fly_distance)
